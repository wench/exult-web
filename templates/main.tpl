						...
						<table border="0" cellpadding="0" cellspacing="0" width="100%">
							...
							<tr>
								<td align="center">
									...
									&nbsp;
									<a href="http://validator.w3.org/check/referer"><img src="http://www.w3.org/Icons/valid-html40" alt="Valid HTML 4.0!" height="31" width="88" border="0"></a>
								</td>
							</tr>
							<tr>
								<td align="center">&nbsp;</td>
							...
							<tr>
								<td align="center">
									<address><small>Problems with Exult or this webpage? <a href="http://exult.info/forum/memberlist.php?mode=contactadmin">Contact us.</a></small></address>
								</td>
							</tr>
						</table>
					</td>
